...
public class QtyUomExtractorTest extends Assert {
    ...
    @Test
    public void computeAccuracy_checkIsHigherThan20Percent() throws IOException, URISyntaxException {
       ...
       int count =0;
        ...
        List<String> lines = Files.readAllLines(Paths.get(getClass().getResource("/qty_uom_challenge_dataset_clean.csv").toURI()));
